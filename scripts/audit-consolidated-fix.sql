-- =============================================
-- KIFSHOP COMPREHENSIVE AUDIT FIX
-- Exécuter ce script pour fixer toutes les anomalies
-- =============================================

-- ============================================================
-- PHASE 1: Drop les politiques RLS défaillantes
-- ============================================================

-- Clients RLS - permissive
...
-- ============================================================
-- PHASE 2: Créer les tables métier manquantes
-- ============================================================
...
-- ============================================================
-- PHASE 3: Corriger les types tenant_id dans les tables existantes
-- ============================================================

-- Ajouter les colonnes manquantes à tenants
...
-- ============================================================
-- PHASE 4: Appliquer les politiques RLS correctes
-- ============================================================

-- CLIENTS RLS - SÉCURISÉE
...
-- ============================================================
-- PHASE 5: Indexes pour performance
-- ============================================================
