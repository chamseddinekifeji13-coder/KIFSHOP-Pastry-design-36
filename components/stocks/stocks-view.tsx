      ...
      <Tabs value={selectedTab} onValueChange={setSelectedTab}>
        <div className="overflow-x-auto -mx-4 px-4 sm:mx-0 sm:px-0" style={{ WebkitOverflowScrolling: "touch", scrollbarWidth: "none", msOverflowStyle: "none" }}>
          <TabsList style={{ width: "max-content" }}>
            ...
            <TabsTrigger value="finished" className="gap-1.5" style={{ flex: "none" }}>
            ...
            <TabsTrigger value="packaging" className="gap-1.5" style={{ flex: "none" }}>
            ...
            <TabsTrigger value="consumables" className="gap-1.5" style={{ flex: "none" }}>
